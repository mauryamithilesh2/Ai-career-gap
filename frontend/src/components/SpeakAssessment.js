        ...
        <Dashboard>
            <div className="max-w-5xl mx-auto p-3 sm:p-4 space-y-6">
                ...
                <div className="text-center mb-6">
                    <div className="inline-flex items-center justify-center w-14 h-20 bg-primary-100 rounded-full mb-3">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-center">
                                    <button
                                        ...
                                        disabled={loading}
                                        className={`relative w-20 h-24 rounded-full flex items-center justify-center text-white font-semibold transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-offset-2 ${
                                            recording
